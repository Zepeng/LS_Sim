...
#ifndef LSCherenkov_h
#define LSCherenkov_h 1
...
class LSCherenkov : public G4VProcess
{
...
public:
  ...
  explicit LSCherenkov(const G4String& processName = "Cerenkov", 
             G4ProcessType type = fElectromagnetic);
  ~LSCherenkov();

  explicit LSCherenkov(const LSCherenkov &right);
...
private:
  ...
  LSCherenkov& operator=(const LSCherenkov &right) = delete;
...
public:
  ...
  void SetScaleFactor(const G4double scale);

  G4double GetScaleFactor() const; 
...
inline
G4bool LSCherenkov::GetTrackSecondariesFirst() const
{
  return fTrackSecondariesFirst;
}

inline
G4double LSCherenkov::GetMaxBetaChangePerStep() const
{
  return fMaxBetaChange;
}

inline
G4int LSCherenkov::GetMaxNumPhotonsPerStep() const
{
  return fMaxPhotons;
}

inline
void LSCherenkov::SetStackPhotons(const G4bool stackingFlag)
{
        fStackingFlag = stackingFlag;
}

inline
G4bool LSCherenkov::GetStackPhotons() const
{
        return fStackingFlag;
}

inline
G4int LSCherenkov::GetNumPhotons() const
{
        return fNumPhotons;
}

inline
G4PhysicsTable* LSCherenkov::GetPhysicsTable() const
{
